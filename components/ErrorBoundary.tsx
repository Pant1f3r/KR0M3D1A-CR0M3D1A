...
export class ErrorBoundary extends Component<Props, State> {
  // FIX: Using class property syntax for state and an arrow function for method binding is a modern and robust approach for React class components. It resolves issues with the 'this' context, ensuring `this.setState` and `this.props` are always available.
  state: State = {
    hasError: false,
    error: null,
  };
