...
// FIX: Add a `useToasts` hook to manage the state of toasts application-wide.
// This encapsulates the logic for adding and removing toasts.
export const useToasts = () => {
  const [toasts, setToasts] = useState<ToastType[]>([]);

  const addToast = useCallback((message: string, type: ToastType['type'], duration?: number) => {
