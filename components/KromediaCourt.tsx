        ...
        <div>
            ...
            <div className="space-y-2 overflow-y-auto pr-2 h-24">
                {dossierEntries.length > 0 ? dossierEntries.map(([signature, count]) => {
                    const progress = (Number(count) / THRESHOLD) * 100;
                    return (
...
export const Arconomics: React.FC<ArconomicsProps> = ({ 
    ...
    const filteredAnomalies = useMemo(() => {
        ...
        const searchTerm = anomalyFilter.toLowerCase();
        return anomalies.filter(a => 
            a.signature.toLowerCase().includes(searchTerm) ||
            a.targetSystem.toLowerCase().includes(searchTerm) ||
    ...
    return (
        <main className="mt-8 space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                        ...
                        <h3 className="text-lg font-semibold text-gray-200 mb-2 flex items-center gap-2">
                         ...
                         <div className="relative mb-2">
                            ...
                            <input
                                ...
                                className="w-full p-1.5 pl-9 text-xs bg-gray-900/50 border border-gray-600 rounded-md focus:ring-1 focus:ring-cyan-500"
                            />
                        </div>
                        <div className="font-mono text-sm space-y-2 overflow-y-auto pr-2 h-40">
                            ...
                            {filteredAnomalies.length === 0 && (
                                <div className="flex items-center justify-center h-full text-gray-500 text-center text-xs">
                ...
                <div className="lg:col-span-3 bg-gray-800 border border-gray-700 rounded-lg p-4 h-[600px] flex flex-col justify-around space-y-4">
                    <div className="text-center">
