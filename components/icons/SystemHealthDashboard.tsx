...
export const SystemHealthDashboard: React.FC<SystemHealthDashboardProps> = ({ healthData, guardrailStats }) => {
    const { guardrailIntegrity, guardrailEfficacy, guardrailEfficiency, threatLevel, communityTrust, aiLatency, activityLog, systemAlerts, matrixState } = healthData;
    ...
    // Logic to determine the color for gauges
    ...
    const efficiencyColorConfig = getIntegrityColor(guardrailEfficiency);
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                ...
                <MetricGauge title="Guardrail Efficacy" value={guardrailEfficacy} unit="%" color="orange" />
                <MetricGauge title="Guardrail Efficiency" value={guardrailEfficiency} unit="%" color={efficiencyColorConfig} />
