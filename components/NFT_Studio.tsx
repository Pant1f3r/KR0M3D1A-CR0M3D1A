...
const LoadingSkeleton: React.FC = () => (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Image Skeleton */}
        <div className="w-full aspect-square rounded-lg skeleton-shimmer"></div>
        ...
        <div className="space-y-4">
            ...
            <div className="h-6 skeleton-shimmer rounded w-1/3 mt-4"></div>
            <div className="flex flex-wrap gap-2">
                <div className="h-12 skeleton-shimmer rounded w-1/4"></div>
                <div className="h-12 skeleton-shimmer rounded w-1/4"></div>
                <div className="h-12 skeleton-shimmer rounded w-1/4"></div>
            </div>
        </div>
